  ...
  return (
    <section id='experience-section' className='work-experience-outer-container'>
      ...
      <div className='experience-right-container'>
        ...
        <p className='experience-position'><i>Graduate of Front End Development Program</i></p>
        ...
        <ul>
          ...
          <li className='experience-item'>Focused on JavaScript fundementals for 12 weeks</li>
