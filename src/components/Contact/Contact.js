...
export const Contact = () => {
  return (
    <section id='contact-section' className='contact-outer-container'>
      ...
      <a rel='noopener noreferrer' tabIndex='-1' href={resumeData.resumeURL} target='_blank'><button aria-label='view resume as PDF' className='resume-button-footer'>view resume.pdf</button></a>
