    ...
    <section id='about-section' className='about-outer-container'>
      ...
      <div className='about-info-container'>
        ...
        <div className='contact-info-container'>
          ...
          <a rel='noopener noreferrer' aria-label='view resume as PDF' href={resumeData.resumeURL} target='_blank'><button className='resume-button'>view resume.pdf</button></a>
        </div>
      </div>
    </section>
  );
