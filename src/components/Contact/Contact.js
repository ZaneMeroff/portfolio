...
export const Contact = () => {
  return (
    <section id='contact-section' className='contact-outer-container'>
      ...
      <a rel='noopener noreferrer' aria-label='view resume as PDF' href={resumeData.resumeURL} target='_blank'><button className='resume-button-footer'>view resume.pdf</button></a>
