export const resumeData = {
  resumeURL: "https://alumni.turing.io/sites/default/files/resumes/Zachary_Nemeroff_resume_2020_0.pdf",
  ...
  bioDescription: "My name is Zachary Nemeroff, and I'm an enthusiastic JavaScript developer passionate about test driven development and object-oriented programming using agile workflow processes. I've built numerous responsive and accessible apps using REST APIs with JavaScript, TypeScript, HTML5, CSS3, jQuery, React, and React Native while creating comprehensive unit testing suites. More recently, I’ve focused on mastering Vue.js, Vuex, and Vue Router to create robust single page web apps that boast thorough unit and integration testing. I'm constantly seeking opportunities calling for creative solutions, so I may expand my knowledge and grow technical skills outside of my comfort zone. If you're up for a challenge, try the Mr. Simon game I created below!",
  education: {
  ...
  jobs: [
    ...
    },
    {
      ...
      description: [
        "Sole general manager responsible for overseeing two million dollar gross annual operation",
